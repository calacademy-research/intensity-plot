...
var curfile, primer_nm, primer_min, primer_max, primer_suffix = "_AllelCall.txt" //02May2016 JBH add min max
...
var orig_hits = {}, pop_info = {}, pts_merged = {};
var num_pops = 0;// number of populations
var names = []; // each sample name in this array is also in the hits object above with its own array of hit info
var sample_pts_trimmed = {}; // 10May2016 JBH each sample has .left and .right arrays to show any pts trimmed when having too few reads for distal support
...
function muSaveData() {
    ...
    filename = projectDirectory + muInfoFile;
    saveServer(filename, muStr);
}

function muLoadData() {
    var fullMu = {};
    var muinfoFile = mu.projectDirectory + "/" + muInfoFile;
    reset_mu_data();
