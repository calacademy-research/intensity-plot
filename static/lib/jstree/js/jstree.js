...
(function (factory) {
     ...
     *
     * You can also set this to a function, that function will receive the node IDs
     * being loaded as argument and a second param which is a function (callback)
     * which should be called with the result.
     *
     * Both the AJAX and the function approach rely on the same return value -
     * an object where the keys are the node IDs, and the value is the children of that node as an array.
     *
     *    {
